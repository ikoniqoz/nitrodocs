...
<p>NitroStreams gives you tools to allow for modification of data through NitroCMS page templates, so you can build data interactions without having to give users access to your control panel.</p>
...
<p>NitroStreams allows you to display a create or edit form using the NitroCMS tag system. Forms are generated using the following format:</p>
...
reCAPTCHA is a simple and high quality CAPTCHA tool, and NitroStreams makes it easy to implement. To start, get your public and private keys from <a href="http://www.google.com/recaptcha">reCAPTCHA</a>. Then, add those keys into the reCAPTCHA config file, located in <strong>streams/config/recaptcha.php</strong>.
...
<tr> 
	...
	<td>Optional custom from email. This can be a single email address or an email address and name separated by a pipe (|) character. If no value is provided, NitroStreams will use your admin email and site name as the from value.</td> 
</tr> 
</table>
